...
public class OverviewKpiServiceImpl implements OverviewKpiService {
	...
	public String getThismonthTesttimes(String month, String groupid) {
		...
		JSONObject dataJSON = new JSONObject();
		if (!"".equals(groupid)) {
			String thismonthTesttimes = kpiDao.getThismonthTesttimes(month, groupid);
			dataJSON.put("thismonth_testtimes", thismonthTesttimes);
		} else {
			dataJSON.put("thismonth_testtimes", "");
		}
		return dataJSON.toString();
	}
}
