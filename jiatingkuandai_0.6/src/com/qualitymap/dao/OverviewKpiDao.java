...
public interface OverviewKpiDao {
	 ...
	 * @return String
	 */
	List<Map<String, Object>> getTerminalNum(String premonth,String thismonth, String groupid);
	 ...
	 * @return String
	 */
	List<Map<String, Object>> getRegusernameNum(String premonth,String thismonth, String groupid);
	/**
	 * 获取累计使用用户数及增长百分比
	 * @param month
	 * @param groupid
	 ...
	 * @return String
	 */
	List<Map<String, Object>> getCustomersNum(String premonth,String thismonth, String groupid);
	/**
	 * 获取新增启动数及增长百分比
	 * @param month
	 * @param groupid
	 ...
	 * @return String
	 */
	List<Map<String, Object>> getNewlyIncreaseNum(String premonth,String thismonth, String groupid);
	 ...
	 * @return String
	 */
	List<Map<String, Object>> getThismonthTesttimes(String premonth,String thismonth, String groupid);
