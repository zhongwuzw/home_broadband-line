...
xls_path = u"/Users/zhongwu/Documents/移动研究院/hlj.xlsx"
...
def executeResultInsertDatabase(ip_start, ip_end, operator_manual, province):
    ...
    try:
        with destDatabase.cursor() as cursor:
            ...
            sql = "INSERT INTO `ip_all_province_hlj` (`id`, `ip_start`, `ip_end`, `operator_manual`, `province`, `city`, `description`, `update_time`, `ip2long_start`, `ip2long_end`, `ip_1_2_start`, `ip_1_2_end`, `flag`) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
        ...
        try:
            ...
            with destDatabase.cursor() as cursor:
                sql = "select ip_start, ip_end, operator_manual, province FROM ip_all_province_hlj where ip_start = '" + ip_start + "' or ip_end = '" + ip_end + "'"
                cursor.execute(sql)
