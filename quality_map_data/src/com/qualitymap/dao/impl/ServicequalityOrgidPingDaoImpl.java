...
public class ServicequalityOrgidPingDaoImpl implements ServicequalityOrgidPingDao {
	...
	public String getValidSampleNum(String month, String groupid,String broadType) {
		String sql = "select IFNULL(sum(ping_test_times),0) ping_test_times from servicequality_orgid_ping where  month= '"+month+"' and groupid = '"+groupid+"' and broadband_type = '"+broadType+"' ";
