...
public interface ServicequalityGroupidWebbrowsingService {
	 ...
	 * @return String
	 */
	String getPageAvgNinetyDelay(String yearMonth,String groupid);
	 ...
	 * @return String
	 */
	String getPageNinetyDelayData(String groupid,String probetype);
	 ...
	 * @return String
	 */
	String getPageNinetyDelayOrder(String month,String groupid,String probetype);
