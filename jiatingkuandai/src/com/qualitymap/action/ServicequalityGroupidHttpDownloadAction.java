...
public class ServicequalityGroupidHttpDownloadAction extends BaseAction {
	 ...
	 * @return void
	 */
	public void getDownloadSuccessRateOrder() {
		...
		try {
			...
			String delayOrder = groupidHttpDownloadService.getDownloadSuccessRateOrder(month, groupid, probetype);
	...
	public void getDownloadSuccessRateData() {
		...
		try {
			...
			String groupid = this.getUserGroup(uuid);
			 //String groupid = "50071,50074,50067";
			String avgdelayData = groupidHttpDownloadService.getDownloadSuccessRateData(groupid, probetype);
			printWriter(avgdelayData);
		} catch (Exception e) {
			e.printStackTrace();
		}
