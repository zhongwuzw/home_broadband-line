...
public interface ServicequalityGroupidWebbrowsingDao {
	 ...
	 * @return List<Map<String,Object>>
	 */
	List<Map<String, Object>> getPageNinetyDelayData(String groupid,String probetype);
	 ...
	 * @return List<Map<String,Object>>
	 */
	List<Map<String, Object>> getPageNinetyDelayOrder(String thismonth,String premonth,String groupid,String probetype);
