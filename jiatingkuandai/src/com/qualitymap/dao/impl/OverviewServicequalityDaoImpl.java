...
public class OverviewServicequalityDaoImpl implements OverviewServicequalityDao {
	...
	public List<Map<String, Object>> getSpecialCaseHttpDownloadRate(String groupid, String month, String broadband_type) {
		...
		String sql = "select  CASE probetype WHEN 'Android' THEN '安卓' WHEN 'PC' THEN '桌面' WHEN 'iOS' THEN '苹果'  END  probetype  ,  case  when operator LIKE '移动' or '中国移动' then '移动' when operator LIKE '联通' or '中国联通' then '联通' when operator LIKE '电信' or '中国电信' THEN '电信' end  operator, " +
				...
				+ "  CONCAT(round(download_test_times*top95_download_rate/(sum(download_test_times)),2),\"Mbps\") percent95 ,CONCAT(round(download_test_times*top85_download_rate/(sum(download_test_times)),2),\"Mbps\")  percent85,CONCAT(round(download_test_times*top75_download_rate/(sum(download_test_times)),2),\"Mbps\") percent75,"
				+ " CONCAT(round(download_test_times*avg_download_rate/sum(download_test_times),2),\"Mbps\") avgvalue " + " from servicequality_operator_httpdownload where month='" + month
	...
	public List<Map<String, Object>> getSpecialCasebufferVideo(String groupid, String month, String broadband_type) {
		...
		String sql = "select CASE probetype WHEN 'Android' THEN '安卓' WHEN 'PC' THEN '桌面' WHEN 'iOS' THEN '苹果'  END  probetype ,  case  when operator LIKE '移动' or '中国移动' then '移动' when operator LIKE '联通' or '中国联通' then '联通' when operator LIKE '电信' or '中国电信' THEN '电信' end  operator, " +
				...
				+ "  CONCAT(round(video_test_times*top95_avg_buffer_proportion/(sum(video_test_times)),2)*100,'%') percent95 ,CONCAT(round(video_test_times*top85_avg_buffer_proportion/(sum(video_test_times)),2)*100,'%')  percent85,CONCAT(round(video_test_times*top75_avg_buffer_proportion/(sum(video_test_times)),2)*100,'%') percent75,"
				+ " CONCAT(round(video_test_times*avg_buffer_proportion/sum(video_test_times),2)*100,'%') avgvalue " + " from servicequality_operator_video where month='" + month
				+ "' and groupid in (" + groupid + ") and broadband_type='" + broadband_type + "' and(operator LIKE '%移动' or operator LIKE '%联通' or operator LIKE '%电信')  group by probetype, " +
				" case  when operator LIKE '移动' or '中国移动' then '移动' when operator LIKE '联通' or '中国联通' then '联通' when operator LIKE '电信' or '中国电信' THEN '电信' end  order by  CASE probetype WHEN 'Android' THEN '1' WHEN 'PC' THEN '3' WHEN 'iOS' THEN '2'  END,case  when operator LIKE '移动' or'中国移动' then '1移动' when operator LIKE '联通' or '中国联通' then '3联通' when operator LIKE '电信' or '中国电信' THEN '2电信' end  ";
		List<Map<String, Object>> proportionList = getSession().createSQLQuery(sql).setResultTransformer(Transformers.ALIAS_TO_ENTITY_MAP).list();
		return proportionList;
	...
	public List<Map<String, Object>> getSpecialCaseFirstDelayVideo(String groupid, String month, String broadband_type) {
		...
		String sql = "select CASE probetype WHEN 'Android' THEN '安卓' WHEN 'PC' THEN '桌面' WHEN 'iOS' THEN '苹果'  END  probetype ,  case  when operator LIKE '移动' or '中国移动' then '移动' when operator LIKE '联通' or '中国联通' then '联通' when operator LIKE '电信' or '中国电信' THEN '电信' end  operator, " +
				...
				+ "  CONCAT(round(video_test_times*top95_first_buffer_delay/(sum(video_test_times)),0),'ms') percent95 ,CONCAT(round(video_test_times*top85_first_buffer_delay/(sum(video_test_times)),0),'ms')  percent85,CONCAT(round(video_test_times*top75_first_buffer_delay/(sum(video_test_times)),0),'ms') percent75,"
				+ " CONCAT(round(video_test_times*first_buffer_delay/sum(video_test_times),0),'ms') avgvalue " + " from servicequality_operator_video where month='" + month
				+ "' and  groupid in (" + groupid + ")  and broadband_type='" + broadband_type + "' and(operator LIKE '%移动' or operator LIKE '%联通' or operator LIKE '%电信')  group by probetype, " +
				" case  when operator LIKE '移动' or '中国移动' then '移动' when operator LIKE '联通' or '中国联通' then '联通' when operator LIKE '电信' or '中国电信' THEN '电信' end  order by  CASE probetype WHEN 'Android' THEN '1' WHEN 'PC' THEN '3' WHEN 'iOS' THEN '2'  END,case  when operator LIKE '移动' or'中国移动' then '1移动' when operator LIKE '联通' or '中国联通' then '3联通' when operator LIKE '电信' or '中国电信' THEN '2电信' end  ";
		List<Map<String, Object>> proportionList = getSession().createSQLQuery(sql).setResultTransformer(Transformers.ALIAS_TO_ENTITY_MAP).list();
		return proportionList;
	...
	public List<Map<String, Object>> getSpecialCaseCacheCountVideo(String groupid, String month, String broadband_type) {
		...
		String sql = "select CASE probetype WHEN 'Android' THEN '安卓' WHEN 'PC' THEN '桌面' WHEN 'iOS' THEN '苹果'  END  probetype ,  case  when operator LIKE '移动' or '中国移动' then '移动' when operator LIKE '联通' or '中国联通' then '联通' when operator LIKE '电信' or '中国电信' THEN '电信' end  operator, " +
				...
				+ "  CONCAT(round(video_test_times*top95_cache_count/(sum(video_test_times)),1),\"次\") percent95 ,CONCAT(round(video_test_times*top85_cache_count/(sum(video_test_times)),1),\"次\")  percent85,CONCAT(round(video_test_times*top75_cache_count/(sum(video_test_times)),1),\"次\") percent75,"
				+ " CONCAT(round(video_test_times*video_cache_count/sum(video_test_times),1),\"次\") avgvalue " + " from servicequality_operator_video where month='" + month
				+ "' and  groupid in (" + groupid + ")  and broadband_type='" + broadband_type + "' and(operator LIKE '%移动' or operator LIKE '%联通' or operator LIKE '%电信')  group by probetype, " +
				" case  when operator LIKE '移动' or '中国移动' then '移动' when operator LIKE '联通' or '中国联通' then '联通' when operator LIKE '电信' or '中国电信' THEN '电信' end  order by  CASE probetype WHEN 'Android' THEN '1' WHEN 'PC' THEN '3' WHEN 'iOS' THEN '2'  END,case  when operator LIKE '移动' or'中国移动' then '1移动' when operator LIKE '联通' or '中国联通' then '3联通' when operator LIKE '电信' or '中国电信' THEN '2电信' end  ";
		List<Map<String, Object>> proportionList = getSession().createSQLQuery(sql).setResultTransformer(Transformers.ALIAS_TO_ENTITY_MAP).list();
		return proportionList;
	...
	public List<Map<String, Object>> getSpecialCaseNinetyDelayWebbrowsing(String groupid, String month, String broadband_type) {
		...
		String sql = "select CASE probetype WHEN 'Android' THEN '安卓' WHEN 'PC' THEN '桌面' WHEN 'iOS' THEN '苹果'  END  probetype ,  case  when operator LIKE '移动' or '中国移动' then '移动' when operator LIKE '联通' or '中国联通' then '联通' when operator LIKE '电信' or '中国电信' THEN '电信' end  operator, " +
				...
				+ "  CONCAT(round(page_test_times*top95_page_avg_ninetydelay/(sum(page_test_times)),0),'ms') percent95 ,CONCAT(round(page_test_times*top85_page_avg_ninetydelay/(sum(page_test_times)),0),'ms')  percent85,CONCAT(round(page_test_times*top75_page_avg_ninetydelay/(sum(page_test_times)),0),'ms') percent75,"
				+ " CONCAT(round(page_test_times*page_avg_ninetydelay/sum(page_test_times),0),'ms') avgvalue " + " from servicequality_operator_webbrowsing where month='" + month
				+ "' and  groupid in (" + groupid + ")  and broadband_type='" + broadband_type + "' and(operator LIKE '%移动' or operator LIKE '%联通' or operator LIKE '%电信')  group by probetype, " +
				" case  when operator LIKE '移动' or '中国移动' then '移动' when operator LIKE '联通' or '中国联通' then '联通' when operator LIKE '电信' or '中国电信' THEN '电信' end  order by  CASE probetype WHEN 'Android' THEN '1' WHEN 'PC' THEN '3' WHEN 'iOS' THEN '2'  END,case  when operator LIKE '移动' or'中国移动' then '1移动' when operator LIKE '联通' or '中国联通' then '3联通' when operator LIKE '电信' or '中国电信' THEN '2电信' end  ";
		List<Map<String, Object>> proportionList = getSession().createSQLQuery(sql).setResultTransformer(Transformers.ALIAS_TO_ENTITY_MAP).list();
		return proportionList;
	...
	public List<Map<String, Object>> getSpecialCaseAvgDelayWebbrowsing(String groupid, String month, String broadband_type) {
		...
		String sql = "select CASE probetype WHEN 'Android' THEN '安卓' WHEN 'PC' THEN '桌面' WHEN 'iOS' THEN '苹果'  END  probetype ,  case  when operator LIKE '移动' or '中国移动' then '移动' when operator LIKE '联通' or '中国联通' then '联通' when operator LIKE '电信' or '中国电信' THEN '电信' end  operator, " +
				...
				+ "  CONCAT(round(page_test_times*top95_page_delay/(sum(page_test_times)),0),'ms') percent95 ,CONCAT(round(page_test_times*top85_page_delay/(sum(page_test_times)),0),'ms')  percent85,CONCAT(round(page_test_times*top75_page_delay/(sum(page_test_times)),0),'ms') percent75,"
				+ " CONCAT(round(page_test_times*page_avg_delay/sum(page_test_times),0),'ms') avgvalue " + " from servicequality_operator_webbrowsing where month='" + month
				+ "' and  groupid in (" + groupid + ")  and broadband_type='" + broadband_type + "' and(operator LIKE '%移动' or operator LIKE '%联通' or operator LIKE '%电信')  group by probetype, " +
				" case  when operator LIKE '移动' or '中国移动' then '移动' when operator LIKE '联通' or '中国联通' then '联通' when operator LIKE '电信' or '中国电信' THEN '电信' end   order by  CASE probetype WHEN 'Android' THEN '1' WHEN 'PC' THEN '3' WHEN 'iOS' THEN '2'  END,case  when operator LIKE '移动' or'中国移动' then '1移动' when operator LIKE '联通' or '中国联通' then '3联通' when operator LIKE '电信' or '中国电信' THEN '2电信' end ";
		List<Map<String, Object>> proportionList = getSession().createSQLQuery(sql).setResultTransformer(Transformers.ALIAS_TO_ENTITY_MAP).list();
		return proportionList;
