...
import org.apache.commons.fileupload.servlet.MinaRequestContext;
 ...
 */
public abstract class MinaFileUploadBase {
     ...
     */
    public List /* FileItem */ parseRequest(HttpRequestMessage req)
    throws FileUploadException {
        return parseRequest(new MinaRequestContext(req));
    }
    ...
    public List /* FileItem */ parseRequest(RequestContext ctx)
        ...
        try {
            ...
            while (iter.hasNext()) {
                ...
                final String fileName = ((org.apache.commons.fileupload.MinaFileUploadBase.FileItemIteratorImpl.FileItemStreamImpl) item).name;
