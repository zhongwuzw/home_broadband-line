...
public class DealWithBrowseAbs implements DealWithCsv{
	...
	public Map<String,Object> readDetailCsv(String filePath,Integer file_id) {
		...
		try {
			...
			if(csvList.size()==16){
				...
				String[]str = new String[]{test_times,"--","-1","-1","-1","-1"}; 
				csvList.add(str);
			}
			contents.put("test_times",csvList.get(16)[0] != null && !"".equals(csvList.get(16)[0])  ? csvList.get(16)[0] : csvList.get(0)[1]);
			contents.put("test_addr",csvList.get(16)[1] != null  && !"".equals(csvList.get(16)[1]) ? csvList.get(16)[1] : "--");
			
//			contents.put("time_delay",csvList.get(16)[5] != null ? csvList.get(16)[5] : "0");
//			contents.put("max_time_delay",csvList.get(16)[3] != null ? csvList.get(16)[3] : "0");
//			contents.put("min_time_delay",csvList.get(16)[4] != null ? csvList.get(16)[4] : "0");
	...
	public static void main(String[] args){
		...
		DealWithBrowseAbs my = new DealWithBrowseAbs();
		//my.insertData("C:\\Users\\cmcc\\Desktop\\测试能力\\ftp\\0_03002.382_0-2013_07_28_14_53_40_927.deviceInfo.csv","C:\\Users\\cmcc\\Desktop\\测试能力\\0_03002.428_0-2013_07_29_19_07_10_638.abstract.csv");

		myFID.insert(my.getResultSet());
	}
