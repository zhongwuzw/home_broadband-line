...
public class FindDeviceAction implements CmriJsonResponse{

	private static FindDeviceAction instance = null;
	static Logger logger = Logger.getLogger(FindDeviceAction.class);
	
	public static FindDeviceAction getInstance() {
		if(instance == null){
			return new FindDeviceAction();
		}
        return instance;
    }
	
	public FindDeviceAction() {}
