package com.chinamobile.lab.ftpserver;
...
public class FTPServerTest {
    ...
    public static void main(String args[]) {
    	...
    	String confile[] = {"./res/conf/ftpserver/ftpd-typical.xml"};
    	FTPServerTest cli = new FTPServerTest();
        try {

            // get configuration
            FtpServer server = cli.getConfiguration(confile);
            if (server == null) {
                return;
            }
