...
public class InsertMysqlDao{
	...
	public static void main(String[] args) {
		...
		insertMysqlDao.getappIds("");
	}
	public void createDB(String database) {
		String oldUrl = ConfParser.url;
		try {
			ConfParser.url = ConfParser.url.substring(0, ConfParser.url
					.lastIndexOf("/"));
			start();
	...
	public Map<StringBuffer, Boolean> insertMysqlDB(Map dataMap, String keyspace, String numType,
		...
		if (!numType.isEmpty()) {
			...
			if (numType.equals("01001")) {
				resultMap = insertSpeedTest(dataMap, keyspace, numType, detailreport);
			} else if (numType.equals("02001")) {
				resultMap = insertWebBrowser(dataMap, keyspace, numType, detailreport);
			} else if (numType.equals("02011")) {
				resultMap = insertVideoTest(dataMap, keyspace, numType, detailreport);
			} else if (numType.equals("03001") || numType.equals("03011")) {
				resultMap = insertHTTP(dataMap, keyspace, numType, detailreport);
			} else if (numType.equals("04002")) {
					resultMap = insertPING(dataMap, keyspace, numType, detailreport);
			} else if (numType.equals("05001")) {
				resultMap = insertCall(dataMap, keyspace, numType, detailreport);
			} else if (numType.equals("04006")) {
				resultMap = insertResideTest(dataMap, keyspace, numType, detailreport);
			} else if (numType.equals("05002")) {
				resultMap = insertSMS(dataMap, keyspace, numType, detailreport);
			} else if (numType.equals("05005")){
				resultMap = insertSMSQuery(dataMap, keyspace, numType, detailreport);
			}
		}
		return resultMap;
	}
	 ...
	 * 插入speedTest数据
	 */
	public  Map<StringBuffer, Boolean> insertSpeedTest(Map dataMap,String keyspace,String numType,String detailreport){
		...
		return appendSql(map,numType,file_index);
	}
	/**
	 * 插入WebBrowser数据
	 */
	public  Map<StringBuffer, Boolean> insertWebBrowser(Map dataMap,String keyspace,String numType,String detailreport){
		List nameList = new ArrayList();
		List valueList = new ArrayList();
		Map map = new HashMap();
		Set keySet = dataMap.keySet();
	 ...
	 * 插入VideoTest数据
	 */
	public  Map<StringBuffer, Boolean> insertVideoTest(Map dataMap,String keyspace,String numType,String detailreport){
		List nameList = new ArrayList();
		List valueList = new ArrayList();
		Map map = new HashMap();
		Set keySet = dataMap.keySet();
	 ...
	 * 插入HTTP数据
	 */
	public  Map<StringBuffer, Boolean> insertHTTP(Map dataMap,String keyspace,String numType,String detailreport){
		List nameList = new ArrayList();
		List valueList = new ArrayList();
		Map map = new HashMap();
		Set keySet = dataMap.keySet();
...
//				}
	 ...
	 * 插入PING数据
	 */
	public  Map<StringBuffer, Boolean> insertPINGManyToOne(Map allMap,String keyspace,String numType,String detailreport){
	 ...
	 * 插入PING数据
	 */
	public  Map<StringBuffer, Boolean> insertPING(Map dataMap,String keyspace,String numType,String detailreport){
		List nameList = new ArrayList();
		List valueList = new ArrayList();
		Map map = new HashMap();
		Set keySet = dataMap.keySet();
	 ...
	 * 插入call数据
	 */
	public  Map<StringBuffer, Boolean> insertCall(Map dataMap,String keyspace,String numType,String detailreport){
		List nameList = new ArrayList();
		List valueList = new ArrayList();
		Map map = new HashMap();
		Set keySet = dataMap.keySet();
...
//		map.put("network",network);
	 ...
	 * 插入ResideTest数据
	 */
	public  Map<StringBuffer, Boolean> insertResideTest(Map dataMap,String keyspace,String numType,String detailreport){
		List nameList = new ArrayList();
		List valueList = new ArrayList();
		Map map = new HashMap();
		Set keySet = dataMap.keySet();
	 ...
	 * 插入SMS数据
	 */
	public  Map<StringBuffer, Boolean>  insertSMS(Map dataMap,String keyspace,String numType,String detailreport){
		List nameList = new ArrayList();
		List valueList = new ArrayList();
		Map map = new HashMap();
		Set keySet = dataMap.keySet();
	 ...
	 * 插入短信查询数据
	 */
	public  Map<StringBuffer, Boolean>  insertSMSQuery(Map dataMap,String keyspace,String numType,String detailreport){
		List nameList = new ArrayList();
		List valueList = new ArrayList();
		Map map = new HashMap();
		Set keySet = dataMap.keySet();
	...
	private Map<StringBuffer, Boolean> appendSql (Map map,String numType,String fileIndex){
		StringBuffer sql = new StringBuffer("");
...
//	}
	...
	public List getappIds(String sql){
		...
		try {
			String driver = "com.mysql.jdbc.Driver";
			String url = ConfParser.url;
					//.substring(0,ConfParser.url.lastIndexOf("/")+1)+"static_param";
			System.out.println("******************"+url);
			String user = ConfParser.user;
			// String password = "cmrictpdata";
			String password = ConfParser.password;
