...
public class JiaKuanData {
	...
	public static void main(String[] args) {
		...
		/*  String[] args = { "test_map_jiakuan",
		 "overview_kpi_orgid_bandwidth-overview_kpi,overview_kpi_orgid_bandwidth-overview_province,overview_kpi_orgid_operator-network_type,overview_kpi_orgid_operator-network_operator,overview_kpi_orgid_terminal-terminal_model,overview_kpi_orgid_terminal-terminal_os"
