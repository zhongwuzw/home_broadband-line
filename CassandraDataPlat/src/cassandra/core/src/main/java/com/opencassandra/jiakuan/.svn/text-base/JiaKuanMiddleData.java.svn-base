...
public class JiaKuanMiddleData {
	...
	public static void main(String[] args) {
		...
		/*	String[] args = { "test_appreportdata_jiakuan", "video_test_new_201605", "test_middle_table_jiakuan",
				"overview_kpi_orgid_bandwidth,overview_kpi_orgid_operator,overview_kpi_orgid_terminal", "auth", "ios,android", "201605" };*/
