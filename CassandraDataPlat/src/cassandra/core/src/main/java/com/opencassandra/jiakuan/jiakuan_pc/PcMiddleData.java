...
public class PcMiddleData {
	...
	public static void main(String[] args) {
		...
		/*String[] args = { "testdataanalyse", "pc_web_browsing_201610", "jiatingkuandai_statistic", "overview_kpi_orgid_terminal,overview_kpi_orgid_operator,overview_kpi_orgid_bandwidth" , "auth", "pc",
				"201610" };*/
