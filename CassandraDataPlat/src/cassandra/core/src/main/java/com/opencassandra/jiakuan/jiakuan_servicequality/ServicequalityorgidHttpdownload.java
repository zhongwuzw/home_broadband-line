...
public class ServicequalityorgidHttpdownload {
	...
	public static void main(String[] args) {
		...
		// 程序开始时间
				...
				//String[] args = { "pc$test_appreportdata_jiakuan$pc_http_test,app$test_appreportdata_jiakuan$http_test_new_201605", "test_middle_table_jiakuan", "servicequality_orgid_httpdownload", "auth", "201605" };
