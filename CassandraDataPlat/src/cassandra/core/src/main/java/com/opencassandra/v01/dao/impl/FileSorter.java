...
public class FileSorter implements Comparator<File> {
	...
	public static void main(String[] args) {
		File[] list = new File("/home/reportbydate/2016").listFiles();
		Arrays.sort(list, new FileSorter(FileSorter.TYPE_NAME));
		printFileArray(list);
	}
