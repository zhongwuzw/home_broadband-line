...
import com.chinamobile.httpserver.response.file.RequestZipReport;

public class FileRespFactory {
    ...
    static {
    	...
    	DEFAULT_RESP_MAP.put("requestpic", RequestPic.class.getName());
    	DEFAULT_RESP_MAP.put("transaction_d", RequestZipReport.class.getName());
    }
