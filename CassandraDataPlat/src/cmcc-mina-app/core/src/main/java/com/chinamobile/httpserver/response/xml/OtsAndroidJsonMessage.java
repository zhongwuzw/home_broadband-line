...
public class OtsAndroidJsonMessage implements CmriHttpResponse{

	private static OtsAndroidJsonMessage instance = null;
	
	public static OtsAndroidJsonMessage getInstance() {
		if(instance == null){
			return new OtsAndroidJsonMessage();
		}
        return instance;
    }
	
	public OtsAndroidJsonMessage() {}
