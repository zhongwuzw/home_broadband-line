...
/////////////////// /////用户数趋势 end //////////////////////////////
  ...
  $.ajax({  
      type : "post",  
      async : false, //同步执行  
      url:'groupidwebbrowsing/getTop90PageDelay',
      data : {month:yearMonth},  
      dataType : "json", //返回数据形式为json  
      success : function(result) {  
  ...
  $.ajax({  
      type : "post",  
      async : false, //同步执行  
      url:'groupidwebbrowsing/getAvgPageSuccessRate',
      data : {month:yearMonth},  
      dataType : "json", //返回数据形式为json  
      success : function(result) {  
  ...
  $.ajax({  
      type : "post",  
      async : false, //同步执行  
      url:'groupidwebbrowsing/getTop90PageSuccessRate',
      data : {month:yearMonth},  
      dataType : "json", //返回数据形式为json  
      success : function(result) {  
...
////////////////////////// ping  start///////////////////////////////
  ...
  $.ajax({  
      type : "post",  
      async : false, //同步执行  
      url:'groupidpingmap/getAvgPingDelay',
      data : {month:yearMonth},  
      dataType : "json", //返回数据形式为json  
      success : function(result) {  
    	  $("#avgDelayThis").text(result.thismonth);
  ...
  $.ajax({  
      type : "post",  
      async : false, //同步执行  
      url:'groupidpingmap/getTop90PingDelay',
      data : {month:yearMonth},  
      dataType : "json", //返回数据形式为json  
      success : function(result) {  
    	  $("#delayStandardRateThis").html(result.thismonth);
  ...
  $.ajax({  
      type : "post",  
      async : false, //同步执行  
      url:'groupidpingmap/getPingLossRate',
      data : {month:yearMonth},  
      dataType : "json", //返回数据形式为json  
      success : function(result) {  
    	  $("#avgPageSuccessRateThis").html(result.thismonth+"<small>%<small>");
  ...
  $.ajax({  
      type : "post",  
      async : false, //同步执行  
      url:'groupidpingmap/getTop90PingLossRate',
      data : {month:yearMonth},  
      dataType : "json", //返回数据形式为json  
      success : function(result) {  
    	  $("#pageStandardRateThis").html(result.thismonth+"<small>%<small>");
