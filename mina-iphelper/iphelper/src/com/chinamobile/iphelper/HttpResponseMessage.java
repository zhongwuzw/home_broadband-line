...
public class HttpResponseMessage {
	...
	public static final int HTTP_STATUS_REDIRECT_TEMPO = 302;
	...
	public void appendBody(String s) {
		try {
			/**
			 * @author LiuGang This point is the response message encoding
			 *         config point. To enable the scalability of mina http
			 *         server, it is to be needed to take care of the encoding
			 *         charset.
			 */
