...
public class ApplyJsonJedisCilent {
	private static Logger logger = Logger.getLogger(ApplyJsonJedisCilent.class);

	private static JedisPool applyJsonJedisPool;
	
	public static JedisPool getApplyJsonJedisPool() {
		return applyJsonJedisPool;
	}

	public static void setApplyJsonJedisPool(JedisPool applyJsonJedisPool) {
		ApplyJsonJedisCilent.applyJsonJedisPool = applyJsonJedisPool;
	}
	...
	public static String insertObj(String sessionid, int timeout, Serializable obj) {
		...
		Jedis jedis = null;
		try{
			jedis = applyJsonJedisPool.getResource();
