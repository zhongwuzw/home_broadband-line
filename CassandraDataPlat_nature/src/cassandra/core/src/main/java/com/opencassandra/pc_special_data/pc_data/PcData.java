...
public class PcData {
	...
	public static void main(String[] args) {
		...
		/*String[] args = { "map_data_statistic", "overview_kpi_orgid_bandwidth-overview_kpi,overview_kpi_orgid_operator-network_operator,overview_kpi_orgid_terminal|terminal_os", 
							"map_data_statistic", "201605" };*/
		...
		for (int i = 0; i < dataSource.length; i++) {
			...
			if (source.indexOf("-") > 0) {
				...
				/*if (tartable.contains("network_operator") || tartable.contains("overview_kpi")) {
					...
					pcDao.queryLastMonthDataExist(tartable, targetBaseName, lastmonth, month);
				}*/
			}
		}
