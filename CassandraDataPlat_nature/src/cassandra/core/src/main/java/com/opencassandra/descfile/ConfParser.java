...
public class ConfParser {
	...
	public static String bug_reportpath="";
...
//	public static String apikey = "97";
	...
	//业务质量统计部分的sql限制条件参数
	public static String whereparameter = "";
	public static String groupparameter = "";
	...
	static{
		...
		if(myFile.exists()){
			...
			bug_reportpath = IniReader.getValue("MonitorPath", "bug_reportpath", myFile.getAbsolutePath());
			if(bug_reportpath!=null && !bug_reportpath.equals("")){
				if(!bug_reportpath.endsWith("\\")&&!bug_reportpath.endsWith("/")){
					bug_reportpath += System.getProperty("file.separator");
				}
			}
...
//			}
			...
			//业务质量统计部分的sql限制条件参数
			whereparameter = IniReader.getValue("MonitorPath", "whereparameter", myFile.getAbsolutePath());
			groupparameter = IniReader.getValue("MonitorPath", "groupparameter", myFile.getAbsolutePath());
		}
	...
	public static void main(String[] args) throws IOException{
		...
		File file = new File("c:\\dd\\dd\\ll\\ss.txt");
