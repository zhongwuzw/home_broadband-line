...
public class FtpInsertDao {
	...
	public int insert(Map<String,Object> list){
		...
		try{
			...
			String sql = "insert into c_ftp_log (" +
			...
			"protocol,"+ "ftp_type,"+ "time_delay,"+ "avg_velocity,"+"log_detail,"+"file_id," +"org_id"+
					...
					list.get("protocol")+"','"+list.get("ftp_type")+"',"+Integer.parseInt(((String)list.get("time_delay")).replace("ms", ""))+","+
